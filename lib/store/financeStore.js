...
export default function FinanceContextProvider({ children }) {
  ...
  const addExpenseItem = (newExpense) => {
    ...
    const updatedCategory = {
      ...
      categories: [...category.expenses, newExpense.expense]
    };
  ...
  const values={ incomes, addIncomeItem, removeIncomeItem, categories, addExpenseItem, removeExpenseItem, addCategory }
